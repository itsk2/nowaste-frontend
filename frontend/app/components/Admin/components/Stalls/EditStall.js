...
const EditStall = () => {
    ...
    const userId = _id ? JSON.parse(_id) : {};
        ...
        <>
            ...
            >
                <View style={styles.header}>
                    <Text style={styles.registerText}>Edit Stall Details</Text>
                </View>
                    ...
                    <Formik
                        ...
                        onSubmit={async (values) => {
                            try {
                                ...
                                Alert.alert("Stall Edited Successfully", "You can now proceed.", [
                                    {
                                        text: "OK",
                        ...
                        {({
                            ...
                            <View style={styles.form}>
                                ...
                                <TouchableOpacity style={styles.button} onPress={handleSubmit}>
                                    <Text style={styles.buttonText}>Save Stall Information</Text>
                                </TouchableOpacity>
                            </View>
                        )}
                    </Formik>
